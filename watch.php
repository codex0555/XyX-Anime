...
<head>
    ...
    <script type="application/ld+json">{"@context": "https://schema.org", "@type": "WebSite", "url": "https://xyxanime.rf.gd/", "potentialAction": { "@type": "SearchAction", "target": "https://xyxanime.rf.gd/filter?keyword={keyword}", "query-input": "required name=keyword"}}</script>
    ...
    <div class="min-h-screen overflow-x-hidden bg-black w-full mx-auto max-w-screen-2xl">
        ...
        <div class="container">
            <div class="video_part">
                <div class="video-player">
                    <div class="iframe-container">
                        <iframe src="https://the.animezia.com/player/v2.php?id=<?= $url ?>" name="iframe" frameborder="0" scrolling="no" allow="accelerometer; autoplay; encrypted-media;gyroscope; picture-in-picture" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class=" text-center text-white flex-column p-2 info">
                ...
                <strong><?= $getAnime["name"] ?> - EP <?= $getEpisode["ep_num"] ?></strong>
                <div>
            ...
            <div class="provider-section text-center rounded">
                <div class="text-white font-weight-bold">
                    PROVIDERS:
                    <a class="provider-button" href="https://the.animezia.com/player/v1.php?id=<?= $url ?>" target="iframe">SERVER1</a>
                    <a class="provider-button" href="https://the.animezia.com/player/v2.php?id=<?= $url ?>" target="iframe">SERVER2</a>
                </div>
            </div><!-- Its Needs To Be Fixed! -->

            <div class="episode_changer text-center mt-4">
                <div class="text-white episode_changing">
                <?php if($getEpisode['prevEpText'] == "") {
                                            echo "";
                                        } else { ?>
                    <a href="watch<?=$getEpisode['prevEpLink']?>" class="episode-nxt">PREVIOUS EP</a>
                    
                                        <?php } ?>
                    <?php if($getEpisode['nextEpText'] == "") {
                                            echo "";
                                        } else { ?>          
                    <a href="watch<?=$getEpisode['nextEpLink']?>" class="episode-nxt">NEXT EP</a>
                    <?php } ?>
                    </div>
                </div>
        </div>
        ...
        <div class="container-fluid mt-4">
            ...
            <div class="bg-dark rounded mb-4 text-white flex">
               ...
               <div class="image">
                    ...
                    <div class="p-4 width">
                    <div class="anime_name text-truncate">Name: <?= $str = $getAnime["name"] ?></div>
                    <div class="anime_type py-2">Type: <?=$getAnime['type']?></div>
                    <div class="anime_status">Status: <?=$getAnime['status']?></div>
                    <div class="anime_quality py-2">Quality: HD</div>
                    </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
            ...
            <div class="bg-video" style="background-image: url('<?= $getAnime["imageUrl"]; ?>');">
                ...
                ?>
                    <a class="episode-link" href="watch/<?=$episode['episodeId']?>"><?= $episode["episodeNum"] ?></a>
                <?php
                }
                ?>
            </div>
