            ...
            foreach ((array)$json1 as $xamp) {
                ...
                <div class="col-sm-6 col-md-4 col-lg-2 mb-5 adj">
                    ...
                    <div class="spinner-border text-info spinning"></div>
                        <a href="watch/<?= $xamp["animeId"] ?>-episode-1">
                        <img src="<?= $xamp["animeImg"]; ?>" class="card-img-top" height="240" alt="">
                        </a>
                        <div class="play"><i class="fa-solid fa-play"></i></div>
                        <div class="card-body">
                            <span class="subordub"><?php $str = $xamp['animeTitle'];
                                                  $last_word_start = strrpos ( $str , " ") + 1;
                                                  $last_word_end = strlen($str) - 1;
                                                  $last_word = substr($str, $last_word_start, $last_word_end);
                                                  if ($last_word == "(Dub)"){echo "DUB";} else {echo "SUB";}
                                                ?></span>
                            <span class="ep rounded-tr-md bg-red-600"><?php
...
?></span>
                        ...
                        <div class="title text-truncate"><?= $xamp["animeTitle"] ?></div>
                    </div>
                    </div>
                </div>
                <?php
